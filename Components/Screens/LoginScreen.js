  ...
  return (
    <KeyboardAvoidingView
      ...
      <View style={styles.header}>
        ...
        /> */}
        <Text style={{ color: 'white', fontSize: 30, fontWeight: '700',textDecorationColor:'white',textDecorationStyle:'solid' }}>
        AquaPulse {'\n'}
        </Text>
        <Text style={{ color: 'white', fontSize: 20, fontWeight: '700' }}>
          LOGIN HERE USING USER ID AND PASSWORD
        </Text>
        <Animatable.Text
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Forget')}>
          <Text style={{ color: '#501ae1', marginTop: 15 }}>Forgot password?</Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={handleLogin} style={[styles.signIn, { borderColor: '#501ae1', borderWidth: 3, marginTop: 15 }]}>
          <Animatable.Text animation='pulse' easing='ease-in' iterationCount="infinite" style={[styles.textSign, { color: '#501ae1' }]}>
            Login
          </Animatable.Text>
        </TouchableOpacity>

        <TouchableOpacity onPress={() => navigation.navigate('Registration')} style={{ alignItems: 'center' }}>
          <Text style={[styles.textSign, { color: '#501ae1', fontSize: 14 }]}>Create new account</Text>
        </TouchableOpacity>
      </View>
      <View style={{ flex: 1 }} />
    </KeyboardAvoidingView>
